Cypress.Commands.add(
  'testOrganizationDetailsGeneralElements',
  (viewport, creds) => {
    ...
    cy.getElementByTestId('organization-new-address-button').then(
      ($element) => {
        expect($element).to.be.visible;
    ...
    cy.getElementByTestId('organization-new-schedule-button').then(
      ($element) => {
        expect($element).to.be.visible;
    ...
    cy.getElementByTestId('organization-new-social-media-button').then(
      ($element) => {
        expect($element).to.be.visible;
    ...
    cy.getElementByTestId('organization-social-media-title').then(
      ($element) => {
        expect($element).to.be.visible;
    ...
    cy.getElementByTestId('organization-edit-coverage-button').then(
      ($element) => {
        expect($element).to.be.visible;
    ...
    cy.getElementByTestId('organization-service-area-coverage-title').then(
      ($element) => {
        expect($element).to.be.visible;
...
Cypress.Commands.add(
  'testOrganizationDetailsPhotosElements',
  (viewport, creds) => {
    cy.viewport(viewport);
    cy.login(creds.email, creds.password);

    cy.getElementByTestId('table-row-text-1-name').then(($element) => {
      cy.wrap($element[0]).click();
    });
    ...
    cy.getElementByTestId('photos-form-no-approved-photos-text').then(
      ($element) => {
        expect($element).to.be.visible;
    ...
    cy.getElementByTestId('photos-form-all-button')
      .click()
      .then(() => {
        cy.getElementByTestId('photos-form-no-four-square-photos-text').then(
          ($element) => {
            expect($element).to.be.visible;
            expect($element).contain(
...
Cypress.Commands.add(
  'testAddingOrganizationAction',
  (viewport, creds, organization) => {
    cy.viewport(viewport);
    cy.login(creds.email, creds.password);
    ...
    cy.getElementByTestId('modal-header').then(($element) => {
      expect($element).to.be.visible;
      expect($element).contain(
        'Verify Information for ' + organization.name + '?'
      );
    });
...
Cypress.Commands.add(
  'testAddingOrganizationServices',
  (viewport, creds, organization) => {
    cy.viewport(viewport);
    cy.login(creds.email, creds.password);
...
Cypress.Commands.add(
  'testAddingOrganizationAddresses',
  (viewport, creds, organization) => {
    // Register intercepts
    cy.intercept({method: 'PATCH', url: '/v1/organizations/**'}, (req) => {
      delete req.headers['if-none-match'];
    }).as('saveAddress');
    cy.intercept({method: 'GET', url: '/v1/organizations/**'}, (req) => {
      delete req.headers['if-none-match'];
    }).as('loadOrg');
    cy.viewport(viewport);
    cy.login(creds.email, creds.password);
    ...
    cy.getElementByTestId('country_ES').then(($element) => {
      ...
      cy.wrap($element.children()[1]).type(
        organization.locations[0].country_ES
      );
    });
    ...
    cy.getElementByTestId('table-row-text-0-name')
      .contains(organization.locations[0].name)
      .should('be.visible');
  }
);

Cypress.Commands.add(
  'testAddingOrganizationSchedules',
  (viewport, creds, organization) => {
    cy.viewport(viewport);
    cy.login(creds.email, creds.password);
    ...
    cy.getElementByTestId('monday_start').then(($element) => {
      ...
      cy.wrap($element.children()[1]).type(
        organization.schedules[0].monday_start
      );
    });
    cy.getElementByTestId('monday_end').then(($element) => {
      ...
      cy.wrap($element.children()[1]).type(
        organization.schedules[0].monday_end
      );
    });
    cy.getElementByTestId('tuesday_start').then(($element) => {
      ...
      cy.wrap($element.children()[1]).type(
        organization.schedules[0].tuesday_start
      );
    });
    cy.getElementByTestId('tuesday_end').then(($element) => {
      ...
      cy.wrap($element.children()[1]).type(
        organization.schedules[0].tuesday_end
      );
    });
    cy.getElementByTestId('wednesday_start').then(($element) => {
      ...
      cy.wrap($element.children()[1]).type(
        organization.schedules[0].wednesday_start
      );
    });
    cy.getElementByTestId('wednesday_end').then(($element) => {
      ...
      cy.wrap($element.children()[1]).type(
        organization.schedules[0].wednesday_end
      );
    });
    cy.getElementByTestId('thursday_start').then(($element) => {
      ...
      cy.wrap($element.children()[1]).type(
        organization.schedules[0].thursday_start
      );
    });
    cy.getElementByTestId('thursday_end').then(($element) => {
      ...
      cy.wrap($element.children()[1]).type(
        organization.schedules[0].thursday_end
      );
    });
    cy.getElementByTestId('friday_start').then(($element) => {
      ...
      cy.wrap($element.children()[1]).type(
        organization.schedules[0].friday_start
      );
    });
    cy.getElementByTestId('friday_end').then(($element) => {
      ...
      cy.wrap($element.children()[1]).type(
        organization.schedules[0].friday_end
      );
    });
    ...
    cy.getElementByTestId('timezone').then(($element) => {
      ...
      cy.wrap($element.children().children()[0]).select(
        organization.schedules[0].timezone
      );
    });
    ...
    cy.getElementByTestId('saturday_start')
      .scrollIntoView()
      .then(($element) => {
        expect($element).to.be.visible;
        expect($element.children()[0]).contain('Saturday Start');
        cy.wrap($element.children()[1]).type(
          organization.schedules[1].saturday_start
        );
      });
    cy.getElementByTestId('saturday_end').then(($element) => {
      ...
      cy.wrap($element.children()[1]).type(
        organization.schedules[1].saturday_end
      );
    });
    cy.getElementByTestId('sunday_start').then(($element) => {
      ...
      cy.wrap($element.children()[1]).type(
        organization.schedules[1].sunday_start
      );
    });
    cy.getElementByTestId('sunday_end').then(($element) => {
      ...
      cy.wrap($element.children()[1]).type(
        organization.schedules[1].sunday_end
      );
    });
    ...
    cy.getElementByTestId('timezone').then(($element) => {
      ...
      expect($element.children()[0]).contain('Timezone');
      cy.wrap($element.children().children()[0]).select(
        organization.schedules[1].timezone
      );
    });
...
Cypress.Commands.add(
  ...
  (viewport, creds, organization) => {
    ...
    cy.getElementByTestId('phone_type_ES').then(($element) => {
      ...
      cy.wrap($element.children()[1]).type(
        organization.phones[0].phone_type_ES
      );
    });
...
Cypress.Commands.add(
  'testAddingOrganizationSocialMedia',
  (viewport, creds, organization) => {
    cy.viewport(viewport);
    cy.login(creds.email, creds.password);
    ...
    cy.getElementByTestId('name').then(($element) => {
      ...
      cy.wrap($element.children()[1]).then(($childElement) => {
        cy.wrap($childElement.children()[0]).select(
          organization.social_media[0].name
        );
      });
    });
...
Cypress.Commands.add(
  'testAddingOrganizationEditCoverage',
  (viewport, creds, organization) => {
    cy.viewport(viewport);
    cy.login(creds.email, creds.password);
...
Cypress.Commands.add(
  'testOrganizationSocialMediaDisabled',
  (viewport, creds, organization) => {
    cy.viewport(viewport);
    cy.login(creds.email, creds.password);
    ...
    cy.getElementByTestId('name').then(($element) => {
      ...
      cy.wrap($element.children()[1]).then(($childElement) => {
        cy.wrap($childElement.children()[0]).select(
          organization.social_media[1].name
        );
      });
    });
    cy.getElementByTestId('url').then(($element) => {
    ...
    cy.getElementByTestId('name').then(($element) => {
      ...
      cy.wrap($element.children()[1]).then(($childElement) => {
        cy.wrap($childElement.children()[0]).select(
          organization.social_media[2].name
        );
      });
    });
    cy.getElementByTestId('url').then(($element) => {
    ...
    cy.getElementByTestId('name').then(($element) => {
      ...
      cy.wrap($element.children()[1]).then(($childElement) => {
        cy.wrap($childElement.children()[0]).select(
          organization.social_media[3].name
        );
      });
    });
    cy.getElementByTestId('url').then(($element) => {
    ...
    cy.getElementByTestId('organization-new-social-media-button').should(
      'be.disabled'
    );
  }
);
