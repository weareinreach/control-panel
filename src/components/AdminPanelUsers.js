      ...
      openModal({
        form: {
          ...
          initialValues: {
            ...
            email: selectedManager?.email,
            currentLocation: selectedManager?.currentLocation,
            verifyAnswer: selectedManager?.verifyAnswer === true ? 'Yes' : 'No',
            timeCommitAnswer: selectedManager?.timeCommitAnswer === true ? 'Yes' : 'No',
            specifiedTimeCommit: selectedManager?.specifiedTimeCommit,
            auditAnswer: selectedManager?.auditAnswer === true ? 'Yes' : 'No',
            suggestionsAnswer: selectedManager?.suggestionsAnswer === true ? 'Yes' : 'No',
            reviewsAnswer: selectedManager?.reviewsAnswer === true ? 'Yes' : 'No',
            payAnswer: selectedManager?.payAnswer === true ? 'Yes' : 'No',
