    ...
    try {
      ...
      if (venues && venues.length > 0) {
        const target =
          venues.find(
            (venue) =>
              venue.name.toLowerCase().trim() == name.toLowerCase().trim()
          ) ?? null;
        if (target) {
        ...
        <ModalBody mt={10} p={10}>
          <Box>
            ...
            >
              ...
              />
              <path
                d="M7.19231 19.2688C7.07357 19.2688 6.95232 19.2513 6.83233 19.2163C6.1711 19.0176 5.79611 18.3213 5.99485 17.6601C7.41106 12.944 8.69477 5.41799 7.11732 3.45556C6.94107 3.23306 6.67483 3.01432 6.06485 3.06057C4.89239 3.15057 5.00363 5.62424 5.00488 5.64924C5.05738 6.33796 4.5399 6.93795 3.85242 6.98919C3.15369 7.03169 2.56371 6.52421 2.51246 5.83548C2.38372 4.11179 2.91995 0.791892 5.87736 0.56815C7.19731 0.468153 8.29353 0.926888 9.06725 1.88936C12.0309 5.57799 9.02225 16.2714 8.38978 18.3788C8.22728 18.9201 7.7298 19.2688 7.19231 19.2688Z"
                fill="#77B255"
              />
              <path
                d="M31.874 13.0233C32.9095 13.0233 33.7489 12.1839 33.7489 11.1484C33.7489 10.1129 32.9095 9.27344 31.874 9.27344C30.8385 9.27344 29.999 10.1129 29.999 11.1484C29.999 12.1839 30.8385 13.0233 31.874 13.0233Z"
                fill="#5C913B"
              />
              <path
                d="M2.49992 24.2733C3.88059 24.2733 4.99984 23.154 4.99984 21.7734C4.99984 20.3927 3.88059 19.2734 2.49992 19.2734C1.11925 19.2734 0 20.3927 0 21.7734C0 23.154 1.11925 24.2733 2.49992 24.2733Z"
                fill="#9266CC"
              />
              <path
                d="M40.6235 25.5233C41.659 25.5233 42.4984 24.6839 42.4984 23.6484C42.4984 22.6129 41.659 21.7734 40.6235 21.7734C39.588 21.7734 38.7485 22.6129 38.7485 23.6484C38.7485 24.6839 39.588 25.5233 40.6235 25.5233Z"
                fill="#5C913B"
              />
              <path
                d="M29.374 40.5194C30.4095 40.5194 31.2489 39.68 31.2489 38.6445C31.2489 37.609 30.4095 36.7695 29.374 36.7695C28.3385 36.7695 27.499 37.609 27.499 38.6445C27.499 39.68 28.3385 40.5194 29.374 40.5194Z"
                fill="#5C913B"
              />
              <path
                d="M34.9989 6.77328C36.3796 6.77328 37.4989 5.65403 37.4989 4.27336C37.4989 2.89269 36.3796 1.77344 34.9989 1.77344C33.6183 1.77344 32.499 2.89269 32.499 4.27336C32.499 5.65403 33.6183 6.77328 34.9989 6.77328Z"
                fill="#FFCC4D"
              />
              <path
                d="M40.6235 11.7733C41.659 11.7733 42.4984 10.9339 42.4984 9.89838C42.4984 8.86288 41.659 8.02344 40.6235 8.02344C39.588 8.02344 38.7485 8.86288 38.7485 9.89838C38.7485 10.9339 39.588 11.7733 40.6235 11.7733Z"
                fill="#FFCC4D"
              />
              <path
                d="M36.874 16.7733C37.9095 16.7733 38.7489 15.9339 38.7489 14.8984C38.7489 13.8629 37.9095 13.0234 36.874 13.0234C35.8385 13.0234 34.999 13.8629 34.999 14.8984C34.999 15.9339 35.8385 16.7733 36.874 16.7733Z"
                fill="#FFCC4D"
              />
              <path
                d="M9.37494 30.5233C10.4104 30.5233 11.2499 29.6839 11.2499 28.6484C11.2499 27.6129 10.4104 26.7734 9.37494 26.7734C8.33944 26.7734 7.5 27.6129 7.5 28.6484C7.5 29.6839 8.33944 30.5233 9.37494 30.5233Z"
                fill="#FFCC4D"
              />
            </svg>
          </Box>
          ...
          <Box>
            ...
            >
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M21 42C32.598 42 42 32.598 42 21C42 9.40202 32.598 0 21 0C9.40202 0 0 9.40202 0 21C0 32.598 9.40202 42 21 42ZM22.4336 25.7656H20.2959V28H22.4336V25.7656ZM17.9863 13.4336C17.1126 14.3717 16.6758 15.6143 16.6758 17.1611H18.5879C18.6237 16.2301 18.7705 15.5176 19.0283 15.0234C19.4867 14.1354 20.3138 13.6914 21.5098 13.6914C22.4766 13.6914 23.1676 13.9492 23.583 14.4648C24.0055 14.9805 24.2168 15.5892 24.2168 16.291C24.2168 16.7923 24.0736 17.2757 23.7871 17.7412C23.6296 18.0062 23.4219 18.2604 23.1641 18.5039L22.3047 19.3525C21.4811 20.1618 20.9476 20.8815 20.7041 21.5117C20.4606 22.1348 20.3389 22.9583 20.3389 23.9824H22.251C22.251 23.0801 22.3512 22.3997 22.5518 21.9414C22.7594 21.4759 23.207 20.9102 23.8945 20.2441C24.8398 19.3275 25.4665 18.6328 25.7744 18.1602C26.0895 17.6875 26.2471 17.0716 26.2471 16.3125C26.2471 15.0592 25.821 14.0316 24.9688 13.2295C24.1237 12.4202 22.9958 12.0156 21.585 12.0156C20.0596 12.0156 18.86 12.4883 17.9863 13.4336Z"
                fill="#EB5757"
              />
            </svg>
          </Box>
...
DisapprovedModal.propTypes = {
  ...
  selectedPhotos: PropTypes.object.isRequired,
