          ...
          <TabPanel marginTop={2}>
            <Stack spacing={4}>
              <Container>
                <Box {...buttonGroupProps}>
                  <Button
                    ...
                    data-test-id="service-details-button"
                  >
                    Edit Details
                  </Button>
                </Box>
                <SectionTitle data-test-id="service-detail-title">
                  Service Details
                </SectionTitle>
                <KeyValueTable
                  rows={[
              ...
              <Container>
                <Box {...buttonGroupProps}>
                  <Button
                    ...
                    data-test-id="service-new-instruction-button"
                  >
                    New Instructions
                  </Button>
                </Box>
                <SectionTitle data-test-id="service-instruction-title">
                  Access Instructions
                </SectionTitle>
                <Table
              ...
              <Container>
                ...
                <SectionTitle data-test-id="service-address-title">
                  Address
                </SectionTitle>
                {location && (
              ...
              <Container>
                ...
                <SectionTitle data-test-id="service-schedule-title">
                  Schedule
                </SectionTitle>
                {schedule && (
              ...
              <Container>
                ...
                <SectionTitle data-test-id="service-email-title">
                  Email
                </SectionTitle>
              ...
              <Container>
                ...
                <SectionTitle data-test-id="service-phone-title">
                  Phone
                </SectionTitle>
              ...
              <Container>
                <Box {...buttonGroupProps}>
                  <Button
                    ...
                    data-test-id="service-edit-coverage-button"
                  >
                    Edit Coverage
                  </Button>
                </Box>
                <SectionTitle data-test-id="service-coverage-title">
              ...
              <Container>
                <Box {...buttonGroupProps}>
                  <Button
                    ...
                    data-test-id="service-new-note-button"
                  >
                    New Note
                  </Button>
                </Box>
                <SectionTitle data-test-id="service-note-title">
                  Notes
                </SectionTitle>
                <Table
                  headers={[
                  ...
                  rows={notes_log}
                  actions={[{label: 'Delete', onClick: openNotesForm(true)}]}
                />
              </Container>
            </Stack>
          </TabPanel>
          <TabPanel marginTop={2}>
            <Stack space={4}>
              <Container data-test-id="service-properties-help-text-container">
                <p>
                  Before adding a community property to a service, ask yourself:
                  "Does this organization/service have expertise and experience
                  in serving this particular community?"
                </p>
                <p>
                  <b>*Note:</b> <em>"We serve everyone"</em> does not count as
                  demonstrated expertise for our purposes at InReach.
                </p>
              </Container>
              <Spacer />
              <Box {...buttonGroupProps} float="none" textAlign="right">
                <Button
                  onClick={openEditProperties}
                  data-test-id="service-edit-properties-button"
                >
                  Edit Properties
                </Button>
              </Box>
              <Container>
                <SectionTitle data-test-id="service-cost-properties-title">
                  Cost Properties
                </SectionTitle>
                <ListProperties list={costProperties} properties={properties} />
              </Container>
              <Container>
                <SectionTitle data-test-id="service-community-title">
              ...
              <Container>
                <SectionTitle data-test-id="service-language-title">
                  Language Properties
                </SectionTitle>
                <ListProperties
              ...
              <Container>
                <SectionTitle data-test-id="service-additional-title">
          ...
          <TabPanel marginTop={2}>
            <Stack spacing={4}>
              <Container data-test-id="service-tags-help-text-container">
                <p>
                  What <b>“tag(s)”</b> you choose affect(s) when this
                  organization appears in the search results of our free App.
                  For example, if you add a “LGBTQ Centers” tag to a service
                  page, the organization will appear for a user who searches for
                  “Community Support - LGBTQ Centers” in the App. Please try to
                  consider the user’s perspective when entering tag(s).
                </p>
                <p>
                  <b>*Note:</b> Please also make sure to separate an
                  organization's services into unique service pages. This is
                  especially true for legal services. For example, if an
                  organization offers both gender/name change legal services and
                  asylum legal services, these should actually be separate
                  service pages in the data portal (each service page should
                  then have its own distinct, relevant tag). Similarly, if you
                  are using two very different tag types (e.g. transportation
                  and legal), you should likely instead create two different
                  service pages (each with their own distinct tag). Please post
                  in the #community-outreach channel in Slack with any
                  questions.
                </p>
              </Container>
              <Container data-test-id="service-tags-us-container">
                <Box {...buttonGroupProps}>
                  <Button
                    onClick={openEditTags('united_states')}
                    data-test-id="service-us-tags-button"
                  >
                    Edit Tags
                  </Button>
                </Box>
                <SectionTitle data-test-id="service-us-title">
                  United States Tags
                </SectionTitle>
              ...
              <Container data-test-id="service-tags-canada-container">
                <Box {...buttonGroupProps}>
                  <Button
                    onClick={openEditTags('canada')}
                    data-test-id="service-canada-tags-button"
                  >
                    Edit Tags
                  </Button>
                </Box>
                <SectionTitle data-test-id="service-canada-title">
                  Canada Tags
                </SectionTitle>
                {serviceTags?.canada ? (
              ...
              <Container data-test-id="service-tags-mexico-container">
                <Box {...buttonGroupProps}>
                  <Button
                    onClick={openEditTags('mexico')}
                    data-test-id="service-mexico-tags-button"
                  >
                    Edit Tags
                  </Button>
                </Box>
                <SectionTitle data-test-id="service-mexico-title">
                  Mexico Tags
                </SectionTitle>
                {serviceTags?.mexico ? (
